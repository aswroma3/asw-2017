 ...
 *
 * LoggerMessageFilter e' un esempio di filtro, che definisce come filtrare dei messaggi testuali 
 ...
 * da un SimpleMessageFilter (ad esempio, proprio un LoggerMessageFilter).
 *
 * @author Luca Cabibbo
 */
