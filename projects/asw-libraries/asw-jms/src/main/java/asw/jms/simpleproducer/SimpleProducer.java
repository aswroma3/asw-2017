...
public class SimpleProducer {
	...
	/* logger */
	private Logger logger = Logger.getLogger("asw.jms.simpleproducer");
     ...
     */
    public SimpleProducer(String n, String d, String cf, int maxDelay) {
        this.name = n;
    ...
    public SimpleProducer(String n, String d, String cf) {
        this(n, d, cf, 0);
    }	
