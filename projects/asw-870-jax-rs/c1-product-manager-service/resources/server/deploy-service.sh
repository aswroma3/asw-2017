...
sudo ${ASADMIN} create-jdbc-connection-pool --datasourceclassname org.apache.derby.jdbc.ClientDataSource --restype javax.sql.XADataSource --property portNumber=1527:password=APP:user=APP:serverName=10.11.1.111:databaseName=product-db:connectionAttributes=\;create\\=true ${JDBC_CONNECTION_POOL}
