...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CancellableSynchConsumer cs1 = new CancellableSynchConsumer("SynchConsumer GAMMA1", TOPIC_NAME, CONNECTION_FACTORY_NAME, 500);
        ...
        CancellableSynchConsumer cs2 = new CancellableSynchConsumer("SynchConsumer GAMMA2", QUEUE_NAME, CONNECTION_FACTORY_NAME, 200);
