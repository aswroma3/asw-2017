...
public class SimpleAsynchConsumer implements Cancellable, MessageListener {
    ...
    public SimpleAsynchConsumer(String n, String destinationName, String connectionFactoryName, SimpleMessageProcessor mp, int maxDelay) {
     ...
     * che inviera' i messaggi ricevuti al message processor mp. */
    public SimpleAsynchConsumer(String n, Destination d, ConnectionFactory cf, SimpleMessageProcessor mp, int maxDelay) {
