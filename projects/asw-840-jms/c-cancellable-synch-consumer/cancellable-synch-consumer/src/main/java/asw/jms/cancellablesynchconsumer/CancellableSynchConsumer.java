...
public class CancellableSynchConsumer implements Cancellable {
    ...
    /** Crea un nuovo CancellableSynchConsumer, di nome n, per una destinazione destinationName. */
    public CancellableSynchConsumer(String n, String destinationName, String connectionFactoryName) {
